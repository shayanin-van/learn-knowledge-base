---
title: "GiovanniPasq/agentic-rag-for-dummies: A modular Agentic RAG built with LangGraph — learn Retrieval-Augmented Generation Agents in minutes."
source: "https://github.com/GiovanniPasq/agentic-rag-for-dummies"
author:
  - "[[GiovanniPasq]]"
published:
created: 2026-05-09
description: "A modular Agentic RAG built with LangGraph — learn Retrieval-Augmented Generation Agents in minutes. - GiovanniPasq/agentic-rag-for-dummies"
tags:
  - "clippings"
---
[![Agentic RAG for Dummies Logo](https://github.com/GiovanniPasq/agentic-rag-for-dummies/raw/main/assets/logo.png)](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/assets/logo.png)

## Agentic RAG for Dummies

**Build a modular Agentic RAG system with LangGraph, conversation memory, and human-in-the-loop query clarification**

[Overview](#overview) • [How It Works](#how-it-works) • [LLM Providers](#llm-provider-configuration) • [Implementation](#implementation) • [Installation & Usage](#installation--usage) • [Troubleshooting](#troubleshooting)

[![Agentic RAG Demo](https://github.com/GiovanniPasq/agentic-rag-for-dummies/raw/main/assets/demo.gif)](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/assets/demo.gif)
...
> ⚠️
> 
> For reliable tool calling and instruction following, prefer models **7B+**. Smaller models may ignore retrieval instructions or hallucinate. See [Troubleshooting](#troubleshooting).
...
Additional details, extended explanations, and Langfuse observability (LLM call tracing, tool usage, and graph execution tracking) are available in the **[notebook](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/notebooks/agentic_rag.ipynb)** and in the full project.
...
Convert the PDFs to Markdown. For more details about other techniques use this companion [notebook](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/notebooks/pdf_to_markdown.ipynb).
...
Build a Gradio interface with conversation persistence and human-in-the-loop support. For a complete end-to-end pipeline Gradio interface, including document ingestion, please refer to [project/README.md](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/project/README.md).

> **Note:** Full streaming support — including reasoning steps and tool calls visibility — is implemented in the [notebook](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/notebooks/agentic_rag.ipynb) and in the full [project](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/project/core/chat_interface.py). The example below is intentionally minimal — it shows the basic Gradio integration pattern only.
...
Full documentation in [project/README.md](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/project/README.md).
...
See [`project/README.md`](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/project/README.md#Docker-Deployment) for full Docker instructions and system requirements.
...
> 💡 **For additional troubleshooting tips** see the [README Troubleshooting](https://github.com/GiovanniPasq/agentic-rag-for-dummies/blob/main/project/README.md#troubleshooting).